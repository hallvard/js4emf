...
public class ScriptSourceView extends AbstractSelectionView {
	...
	protected boolean isValidSelection(Object o) {
		return o instanceof EObject && JavascriptSupport.getScriptSourceFeatureValueProvider((EObject) o) != null;
	}
	
	private String getScriptText(EObject eObject) {
		final FeatureValueProvider<String> featureValueProvider = JavascriptSupport.getScriptSourceFeatureValueProvider(eObject);
